...
public class Reference{
	public static final String MOD_ID = "All_Light_Blocks";
	...
	public static final String CREATIVE_TAB_NAME_LUMEN16 = "AllLightBlocksLumen16";
	public static final String CREATIVE_TAB_NAME_LUMEN8 = "AllLightBlocksLumen8";
